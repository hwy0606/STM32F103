...
void USART2_BP_Response(u8 *USART_RECEIVE_DATA,u16 DATA_LEN)
{
	...
	USART3_BP_DATA[DATA_LEN+0x03]=Get_ucCRCLo(); //CRC校验码低8位
	USART3_BP_DATA[DATA_LEN+0x04]=Get_ucCRCHi(); //CRC校验码高8位	
